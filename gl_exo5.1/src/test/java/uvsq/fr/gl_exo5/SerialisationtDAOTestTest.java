...
public class SerialisationtDAOTestTest {
	...
	public void setUp() {
		...
		personne = new PERSONNEBuilder("TOUAZI", "LYLIA")
				...
				.fonction(fonction.charger_de_mission)
		...
		personne2 = new PERSONNEBuilder("hamouche", "koussaila")
				...
				.build();
		personne5 = new PERSONNEBuilder("hh", "hh")
				.dateNaissance(LocalDate.parse("1994-04-22"))
				.fonction(fonction.vendeur)
				.addNumeroTelephone(new NumeroTelephone( Type.fix_perso, "dddd"))
				.build();
